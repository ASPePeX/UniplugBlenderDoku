...
{\Large \bfseries Forschungsprojekt - Medieninformatik Master}\\[0.5cm] % Major heading such as course name
...
\HRule \\[0.2cm]
{ \huge \bfseries FUSEE Universal Plugin für 3D-Modellierungssoftware}\\[0cm] % Title of your document: FUSEE mit Blender verdengeln
\HRule \\[0.7cm]
...
%\emph{Supervisor:} \\
Prof. Christoph Müller\\ % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
